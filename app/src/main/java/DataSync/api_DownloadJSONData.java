 ...
 */
public class api_DownloadJSONData extends AsyncTask<String, Void, String> {
    private Context context;
    final String USER_AGENT = ProjectSetting.USER_AGENT_WebAPI;
    HttpURLConnection down_conn = null;
    final String url = ProjectSetting.URL_WebAPI;
    ...
    protected String doInBackground(String... urls) {
        try {
            ...
            byte[] utf8JsonString = urls[0].getBytes("UTF8");
